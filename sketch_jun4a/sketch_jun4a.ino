...
char* topic_diferenta = "nodemcu2/diferenta";//diferenta maxima admisa intre valorile temperaturilor,
char* topic_perioada = "nodemcu2/perioada";//perioada de achizitie a temperaturilor si
char* topic_1wire_rec = "nodemcu2/1wire";//temperatura culeasa de senzorul 1-wire
char* topic_nodemcu = "nodemcu2/#";//topic care cuprinde toate subtopicurile nodemcu
char* topic_wifi_senzor1 = "temperaturi2/wifi/senzor1";//numele topicurilor de pe care primim temperaturile
char* topic_wifi_senzor2 = "temperaturi2/wifi/senzor2";
char* topic_wifi = "temperaturi2/wifi/#";//topic care cuprinde ambele temperaturi
char* topic_1wire = "temperaturi2/1wire";
...
void setup() {
  ...
  while(!client_mqtt.connect(clientID,NULL,NULL,"temperaturi2/wifi/senzor1",2,true,"M-am deconectat...",false)) { //verificam conexiunea drept client MQTT
