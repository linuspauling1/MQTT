...
char* topic_diferenta = "nodemcu2/diferenta";//diferenta maxima admisa intre valorile temperaturilor si
char* topic_perioada = "nodemcu2/perioada";//perioada de achizitie a temperaturilor
char* topic_nodemcu = "nodemcu2/#";//topic care cuprinde toate subtopicurile nodemcu
char* topic_wifi_senzor1 = "temperaturi2/senzori/senzor1";//numele topicurilor de pe care primim temperaturile
char* topic_wifi_senzor2 = "temperaturi2/senzori/senzor2";
char* topic_wifi = "temperaturi2/senzori/#";//topic care cuprinde ambele temperaturi
